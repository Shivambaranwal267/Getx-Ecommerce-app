...
class VariationController  extends GetxController{
  ...
  void onAttributeSelected(ProductModel product, attributeName, attributeValue) {
    ...
    this.selectedAttributes[attributeName] = attributeValue; // selectedAttribute['Color'] : 'Green'

    // get selected variation
    ProductVariationModel selectedVariation = product.productVariations!.firstWhere((variation) =>
   ...
   // OR // this.selectedVariation.value = selectedVariation;
  ...
  bool isSameAttributeValues(Map<String,dynamic> variationAttributes, Map<String, dynamic> selectedAttributes) {
    ...
    // if any of the attributes is diff then return ['Green', 'Large'] != ['Green', 'Small']
  ...
  Set<String?> getAttributesAvailabilityInVariation(List<ProductVariationModel> variations, String attributeName) {
    ...
    final availableAttributesValues = variations.where(
            ...
            variation.attributeValues[attributeName]!.isNotEmpty &&
                ...
                variation.stock > 0).map((variation) =>
